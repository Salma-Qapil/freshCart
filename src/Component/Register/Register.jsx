...
{registerform.touched.name ?<p className='text-danger  my-2'>{registerform.errors.name}</p> :"" }
...
{registerform.touched.email ? <p className='text-danger  my-2'>{registerform.errors.email}</p> :""}
  </div>
  <div className=' my-2'>
...
{registerform.touched.password ? <p className='text-danger  my-2'>{registerform.errors.password}</p>:""}
  </div>
  <div className=' my-2'>
...
{registerform.touched.rePassword ? <p className='text-danger  my-2'>{registerform.errors.rePassword}</p>:""}
...
{registerform.touched.phone?<p className='text-danger  my-2'>{registerform.errors.phone}</p>:""}
  </div>
